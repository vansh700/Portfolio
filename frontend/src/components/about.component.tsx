...
export default function AboutComponent() {
  ...
  const bio = profile?.bio ?? `Hey! I'm <strong>Vansh Soni</strong>, a passionate full-stack developer who loves building things for the web. I specialize in crafting modern, performant applications with great user experiences.`;
  const bio2 = profile?.bio2 ?? `When I'm not coding, I'm exploring new technologies, contributing to open-source projects, or working on my next side project. I believe in writing clean, well-documented code that others can build upon.`;
  const name = profile?.name ?? 'Vansh Soni';
    ...
    <section id="about" className="section">
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        >
          ...
          <div>
            <p
              style={{ color: '#cbd5e1', fontSize: '1.05rem', lineHeight: 1.85, marginBottom: '1rem' }}
            ...
            >
              {stats.map((s) => (
                <div
                  key={s.label}
                  className="glass"
                  style={{ padding: '1rem', textAlign: 'center', borderRadius: 14 }}
                >
        ...
        >
          {highlights.map((h) => (
            ...
            >
              ...
              <div style={{ fontWeight: 700, color: '#e2e8f0', marginBottom: 4, fontSize: '0.9rem' }}>
                {h.label}
              </div>
